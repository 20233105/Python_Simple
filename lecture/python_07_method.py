...
#     15줄 코드 -> 함수로 정의(15회) -> 매일 함수 호출
# ** 함수 개발 가이드라인 **

# 1.함수 이름 및 내용
# + 함수 이름에 함수의 역하로가 의도 명확히 드러낼 것!
# + 함수 내용은 가능하면 짧게 작성(코드 라인 줄이기)
#   ex) def print_hello()
#           print("Hello")
...
# 3.인자(argument or parameter) 저의: 함수 입력값
# 4.return: 함수 종료 의미
...
# - return이 없는 경우 들여쓰기 종류 함수 종료로 간주
...
# - 같은 이름의 지역변수와 전역변수가 존재하는 경우 가까운(지역변수) 우선 순위가 높음
