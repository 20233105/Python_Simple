...
# 2.패키지: 특정 기능과 관련된 여러 모듈의 모음
# 3.모듈: 이미 작성된 프로그램(일반적으로 한 파일(.py)를 의미)

# ** 모듈의 종류
# 1.내부 모듈:Python내에서 제공하는 모듈
...
# 가정: "request" 라이브러리 안에는 1000개 모듈

# 1.import
# ex) import request
# -> "request" 라이브러리 전체 호출(1000개)
# -> requests.get()

# 2.from ~ import
# ex) from requests import get
# -> "request" 라이브러리 내에서 "get" 모듈만 호출(1000개 중 1개)
# -> get()
